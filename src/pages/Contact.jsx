...
export default function Contact() {
  ...
  const processSteps = [
    {
      num: '01',
      title: '고객문의',
      desc: '홈페이지 온라인 제휴문의 신청 또는 대표 번호(02-598-3001) 접수',
      icon: '📞'
    },
    {
      num: '02',
      title: '현장조사분석',
      desc: '담당 물류 컨설턴트가 고객사의 유통망 배송 경로 및 물동량 현장 실사 분석',
      icon: '📊'
    },
    {
      num: '03',
      title: '견적 및 컨설팅',
      desc: '운송 모듈 분석 기반 비용 절감안 제시, 최적 단가 산출 및 견적서 제출',
      icon: '💡'
    },
    {
      num: '04',
      title: '계약 및 실행',
      desc: '최종 운영 계약 체결 및 SLA 협의 후 전담 배송 차량 고정 배치, WMS API 연동',
      icon: '🤝'
    }
  ]
  ...
  const faqs = [
    {
      q: '기업 맞춤형 물류 제휴 계약은 어떻게 진행되나요?',
      a: '우측 제휴 문의 양식을 작성하시거나 고객센터로 연락 주시면, 담당 물류 컨설턴트가 24시간 이내에 전화를 드려 세부 물동량 및 배송 주기를 파악합니다. 현장 실사 후 맞춤형 견적서와 물류 운영 컨설팅을 무상으로 제안해 드립니다.'
    },
    {
      q: '에스원 퀵서비스는 기업 B2B 전용인가요?',
      a: '삼원종합물류의 에스원 퀵서비스는 기본적으로 기업 고객사(B2B)의 월별 통합 정산 및 1:1 알림 관제 시스템을 주로 서비스합니다. 다만 일반 단발성 화물 주선 및 퀵 오더도 친절하게 처리해 드리고 있습니다.'
    },
    {
      q: 'WMS(창고관리시스템) API 연동이 지원되나요?',
      a: '네, 삼원의 스마트 WMS 시스템은 고객사의 사내 ERP 및 주요 쇼핑몰 호스팅사(카페24, 메이크샵 등)의 API 연동을 완벽히 지원합니다. 상품 입출고 정보와 실시간 재고 현황을 한눈에 정확히 모니터링할 수 있습니다.'
    },
    {
      q: 'HACCP 기준 콜드체인 차량이 상시 지원되나요?',
      a: '네, 삼원운수 및 계열사들의 전문 냉장/냉동 탑차 네트워크를 통해 신선식품, 식자재, 온도의 유지가 필요한 의약품 등의 수송을 완벽히 수행합니다. 실시간 온도 관제 장치가 장착되어 있어 온도의 이탈 위험이 없습니다.'
    },
    {
      q: '차량 배차 정보와 배송 현황을 실시간으로 확인할 수 있나요?',
      a: '네, 저희 배차 시스템을 통해 차량 매칭 즉시 차주 기사님의 정보(성함, 차량번호, 연락처)가 연동됩니다. 배송이 완료되면 카카오톡 알림톡을 통해 수령인의 전자 서명 및 완료 현황이 실시간 1:1로 발송됩니다.'
    },
    {
      q: '삼원의 개인 지입 차주로 지원하려면 자격 조건이 어떻게 되나요?',
      a: '기본적으로 화물운송종사자 자격증 및 영업용 번호판을 소지하셔야 합니다. 상세 모집 요건은 "채용정보 > 차주구인" 메뉴에서 현재 진행 중인 공고를 보시고 온라인 또는 유선 지원을 통해 면접을 진행하실 수 있습니다.'
    }
  ]
