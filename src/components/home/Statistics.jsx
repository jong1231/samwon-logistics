      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mt-3">핵심 실적</h2>
            ...
            <ScrollReveal key={i} delay={i * 200}>
              <div className="relative">
                ...
                {i < content.statistics.length - 1 && (
                  <div className="hidden lg:block absolute top-1/2 -right-6 w-px h-16 -translate-y-1/2 bg-white/10" />
                )}
              </div>
            </ScrollReveal>
          ))}
